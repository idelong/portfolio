  ...
  return (
    <div className=" font-oswald">
      <div className="flex items-center absolute inset-x-0 h-16 top-0 z-50 border-solid border-b border-slate-300 bg-white">
        <span className="relative ml-48 text-2xl font-black">Ian DeLong</span>
        ...
        <a className="relative mr-48" href="mailto:iandelong1@gmail.com">
          ...
          <span className="  fold-bold relative inline-block h-full w-full rounded border-2 border-black bg-green-200 px-3 py-1 text-base font-bold text-black transition duration-100 hover:bg-green-300 hover:text-gray-900">hire me</span>
        </a>
      </div>
    </div>
  );
